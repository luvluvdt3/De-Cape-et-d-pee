...
//        GI.nombreJoueurVirtuel = nbjoueur-nbjoueursreels;
	...
	public void dessineInterface(GestionnaireInterfacePP GI) {
        ...
        nompartie.setPromptText(GI.texteLangue.get(GI.langueSelectionne).getProperty("texte.nomPartie"));
        ...
        boutonJouer.setOnAction(e -> { 
        	if(nompartie.getText() == GI.texteLangue.get(GI.langueSelectionne).getProperty("texte.nomPartie") || nompartie.getText() == "")
        		nompartie.setText(GI.texteLangue.get(GI.langueSelectionne).getProperty("texte.idPartie"));
		...
		Label Titre = new Label(GI.texteLangue.get(GI.langueSelectionne).getProperty("texte.creerPartieTitre"));
