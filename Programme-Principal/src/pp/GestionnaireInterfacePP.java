...
public class GestionnaireInterfacePP extends Application {
	...
	HashMap<String,Properties> texteLangue = new HashMap<String,Properties>();
...
//	public String PropertiesLocalisation = "./resources/textes/"; // text file location
	...
	public void start(Stage primaryStage) throws Exception {
		...
		InterfaceBase IAttente = new InterfaceAttente(this);
		InterfaceBase ICreerPartie = new InterfaceCreerPartie(this);
		
		InterfaceBaseList.add(IMenu);
		InterfaceBaseList.add(IAttente);
		InterfaceBaseList.add(Fin);
		InterfaceBaseList.add(Plateau);
		InterfaceBaseList.add(ICreerPartie);
		InterfaceBaseList.add(Lobby);
		
		InterfaceMap.put("Menu", IMenu);
		InterfaceMap.put("Attente", IAttente);
		InterfaceMap.put("Plateau", Plateau);
		InterfaceMap.put("finPartie", Fin);
		InterfaceMap.put("CreerPartie", ICreerPartie);
