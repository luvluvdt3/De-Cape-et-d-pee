...
//-----------------Créations des composants------------------------------------------------  
		...
		boutonJouer = new Button(GI.texteLangue.get(GI.langueSelectionne).getProperty("bouton.creerPartie"));
		...
		boutonLangue = new Button(GI.langueSelectionne);
		boutonLangue.setOnAction(e -> {
			GI.langueSelectionne = (GI.langueSelectionne == "francais") ?  "english" :  "francais";
			for(InterfaceBase i : GI.InterfaceBaseList)
				i.dessineInterface(GI);
		});
		
		boutonLangue.setPrefWidth(GI.screenBounds.getWidth()*0.26);
		boutonLangue.setStyle("-fx-font: normal 2.5em 'Comic Sans MS' ");
...
//------------------Conteneur boutons-------------------------------------------------------
		VBgauche = new VBox(boutonJouer,boutonLangue);
