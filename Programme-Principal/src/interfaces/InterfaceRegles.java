    ...
    public void dessineInterface(GestionnaireInterface GI) {
		...
		if(GI.langueSelectionne== "francais")
			contenu = "\t Dans un royaume en pleine déroute, des clans rivaux se livrent une lutte sans merci pour "
				...
				+ "On mélange toutes les cartes Objectifs qui seront utilisées pour la partie : 6 cartes "
				...
				+ "Une partie se joue en 6 manches. Au début de chaque manche, on découvre autant "
				...
				+ "d'autres cartes sous les objectifs réalisés. La manche prend fin dès que tous les objectifs "
				...
				+ "--- \t Fin du jeu \n\n"
				+ "Le jeu prend fin après 6 manches, lorsque toutes les cartes Objectif ont été attribuées. "
