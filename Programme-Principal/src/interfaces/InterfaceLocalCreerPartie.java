...
public class InterfaceLocalCreerPartie extends InterfaceBase {
	...
	public void dessineInterface(GestionnaireInterface GI) {
        ...
        difficulte.setValue(GI.texteLangue.get(GI.langueSelectionne).getProperty("texte.choixBot.facile"));
	...
	public void creerPartie(String pseudo, int nbjoueur) {
        ...
        Data data = new Data(jinitiateur, nbjoueur, difficulte.getValue().toLowerCase());
        GI.setData(data);
