...
//			main[0]= reserve[10];
//			main[1]= reserve[this.getCarteInfluenceAleatoireDansReserve()];
//			main[2]= reserve[this.getCarteInfluenceAleatoireDansReserve()];
//			
//		}
//		main[1]= reserve[15];
//		main[2]= reserve[this.getCarteInfluenceAleatoireDansReserve()];
//		main[0]=new Sosie(this.getCouleur());
//		main[1]=new Mendiant(this.getCouleur());
	}
