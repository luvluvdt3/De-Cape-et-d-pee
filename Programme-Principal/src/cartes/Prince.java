...
//			if(((carte instanceof Prince || carte instanc                                                                    eof Ecuyer) && carte.getCouleur() != this.getCouleur()) && data.getPlateau().getColonne(indexColonne).getIndexCarteInfluence(carte) < indexCartePlusProche) {
