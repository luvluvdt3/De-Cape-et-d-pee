...
public class Explorateur extends CarteSpeciale{
	...
	public void activer(Data data) throws Exception {
		...
		indexColonneVisee = (indexColonneActuelle+1)%nbColonne; 
//		indexColonneVisee = (indexColonneVisee+detecteurTempete(data, indexColonneVisee, nbColonne))%nbColonne;
		
		System.out.println("Carte explorateur se déplace, Joueur "+ data.getIndexJoueurParCouleur(this.getCouleur()));
