...
public class Message {
	...
	/**
	 * Méthode pour vérifier que lcarte est bien défini.
	 * @param lcarte le paramètre à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
	public List<CarteInfluence> lireLCarte(List<CarteInfluence> lcarte) throws ExceptionMessage {
		if (lcarte.size() !=3)
			throw new ExceptionMessage("Syntaxe incorrecte : Le nombre de cartes doit être de exactement 3");
		return lcarte;
	}
	
	/**
	 * Méthode pour vérifier que ListeJ est bien défini.
	 * @param listeJ le paramètre à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
	public List<String> lireListeJ(List<String> listeJ) throws ExceptionMessage {
		if (listeJ.size() < 2 || listeJ.size()>6)
			throw new ExceptionMessage("Syntaxe incorrecte : Le nombre de joueurs est inccorect");
		return listeJ;
	}
	
	/**
	 * Méthode pour vérifier que idp est bien défini.
	 * @param idpL le paramètre à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
	...
	/**
	 * Méthode pour vérifier que Ip est bien défini.
	 * @param ipL le paramètre à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
	...
	/**
	 * Méthode pour vérifier que le Port est bien défini.
	 * @param partL le port à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
	...
	/**
	 * Méthode pour vérifier qu'un caractère est valide.
	 * @param caractère le caractère à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
	...
	/**
	 * Méthode pour vérifier que le nom de la partie est bien défini.
	 * @param nomPartieL le nom à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
	...
	/**
	 * Méthode pour vérifier que le nombre de joueurs réels maximum est bien défini.
	 * @param nbjrmL le nombre à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
	...
	/**
	 * Méthode pour vérifier que le nombre de joueurs virtuels maximum est bien défini.
	 * @param nbjvmL le nombre à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
	...
	/**
	 * Méthode pour vérifier que le statut de la partie est bien défini.
	 * @param statutL le statut à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
	...
	/**
	 * Méthode pour vérifier que le nombre de joueurs réels connectés est bien défini.
	 * @param nbhrcL le nombre à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
	...
	/**
	 * Méthode pour vérifier que le nombre de joueurs virtuels connectés est bien défini.
	 * @param nbjvcL le nombre à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
	...
	/**
	 * Méthode pour vérifier que le type de partie est bien défini.
	 * @param typepL le type de partie à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
	...
	/**
	 * Méthode pour vérifier que le nombre de joueurs dans la partie est bien défini.
	 * @param taillepL le nombre à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
	...
	/**
	 * Méthode pour vérifier que le type de joueur est bien défini.
	 * @param typejL le type à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
	...
	/**
	 * Méthode pour vérifier que l'identifiant du joueur est bien défini.
	 * @param idjL l'identifiant à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
	...
	/**
	 * Méthode pour vérifier que le nombre de manches est bien défini.
	 * @param nmL le nombre à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
	...
	/**
	 * Méthode pour vérifier que le de la colonne objectif est bien défini.
	 * @param coL le numero à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
	...
	/**
	 * Méthode pour vérifier que l'objectif est bien défini.
	 * @param orL l'objectif à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
	...
	/**
	 * Méthode pour vérifier que l'odentifiant de la nouvelle partie est bien défini.
	 * @param idnpL l'identifiant à vérifier.
	 * @return
	 * @throws ExceptionMessage
	 */
